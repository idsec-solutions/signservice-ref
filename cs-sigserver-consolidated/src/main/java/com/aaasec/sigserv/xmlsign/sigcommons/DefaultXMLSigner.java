 ...
 */
package com.aaasec.sigserv.xmlsign.sigcommons;

import com.aaasec.sigserv.xmlsign.NodeXMLSignatureLocation;
import com.aaasec.sigserv.xmlsign.SimplePkiCredential;
import com.aaasec.sigserv.xmlsign.registry.AlgorithmPredicates;
import com.aaasec.sigserv.xmlsign.registry.AlgorithmRegistry;
import com.aaasec.sigserv.xmlsign.registry.AlgorithmRegistrySingleton;
import com.aaasec.sigserv.xmlsign.registry.SignatureAlgorithm;
...
public class DefaultXMLSigner {
  ...
  private final SimplePkiCredential signingCredential;
   ...
   */
  private NodeXMLSignatureLocation signatureLocation = new NodeXMLSignatureLocation();
   ...
   * . The default is {@code false} (only the entity certificate is
   * included).
   */
   ...
   */
  public DefaultXMLSigner(final SimplePkiCredential signingCredential) {
   ...
   */
  public static DefaultXMLSignerBuilder builder(final SimplePkiCredential signingCredential) {
  ...
  /** {@inheritDoc} */
  public SimplePkiCredential getSigningCredential() {
   ...
   *          location indicator
   */
  public void setSignatureLocation(final NodeXMLSignatureLocation signatureLocation) {
  ...
  public String getSignatureAlgorithm() {
    ...
    if (alg != null) {
      ...
      LOG.info("Using signature algorithm " + this.signatureAlgorithm + " as the default");
      return this.signatureAlgorithm;
    }
    else {
      // Should never happen
  ...
  public static class DefaultXMLSignerBuilder {
     ...
     *          the signing credential to use
     */
    public DefaultXMLSignerBuilder(final SimplePkiCredential signingCredential) {
     ...
     * @return the builder
     */
    public DefaultXMLSignerBuilder signatureLocation(final NodeXMLSignatureLocation signatureLocation) {
